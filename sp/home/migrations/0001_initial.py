# Generated by Django 3.2.12 on 2024-03-04 09:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='home.category', to_field='name')),
                ('seller_name', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='home.seller', to_field='name')),
            ],
        ),
        migrations.CreateModel(
            name='Payment',
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='home.user')),
            ],
        ),
        migrations.CreateModel(
            name='OrderItem',
